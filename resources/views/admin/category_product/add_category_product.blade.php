                            ...
                            <div class="basic-form">
                                <form action="{{route('savecategory')}}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-flat" placeholder="Nhập danh mục sản phẩm " name="category_name" id="title" onkeyup="ChangeToSlug();">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-flat" placeholder="Slug" name="category_slug" id="slug" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea  class="form-control input-flat" style="height: 300px" placeholder="Mô tả danh mục sản phẩm " name="category_desc" ></textarea>
