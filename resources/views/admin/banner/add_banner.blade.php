                            ...
                            <div class="basic-form">
                                <form action="{{route('savebanner')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-flat" placeholder="Nhập tên banner" name="banner_name" id="title" onkeyup="ChangeToSlug();">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-flat" placeholder="Slug" name="banner_slug" id="slug">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="thumbnail" class="form-control" type="text" name="banner_image" value="{{old('banner_image')}}">
                                      </div>
                                    </div>
                                    <div class="form-group">
                                        <p class="text-muted m-b-15 f-s-12">Mô tả banner</p>
                                        <textarea  class="form-control input-flat" style="height: 300px" placeholder="Mô tả banner" name="banner_desc" ></textarea>
