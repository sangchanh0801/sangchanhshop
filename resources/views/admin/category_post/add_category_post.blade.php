                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="{{route('savecategorypost')}}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <p class="text-muted m-b-15 f-s-12">Tên danh mục bài viết</p>
                                        <input type="text" class="form-control input-flat" placeholder="Nhập danh mục sản phẩm " name="category_post_name" id="title" onkeyup="ChangeToSlug();">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-flat" placeholder="Slug" name="category_post_slug" id="slug" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea  class="form-control input-flat" style="height: 300px" placeholder="Mô tả danh mục sản phẩm " name="category_post_desc" ></textarea>
