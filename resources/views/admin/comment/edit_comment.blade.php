                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                    <form action={{route('updatecomment', $edit_comment->id)}} method="post" >
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea  class="form-control input-flat" style="height: 300px" placeholder="Bình luận" name="post_comment" >{{$edit_comment->post_comment}}"</textarea>
                                        </div>
                                        <div class="form-group">
