                            ...
                            <div class="basic-form">
                                <form action="{{route('savepost')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-flat" placeholder="Nhập tên bài viết " name="post_title" id="title" onkeyup="ChangeToSlug();">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-flat" placeholder="Slug" name="post_slug" id="slug">
                                        {{-- @if ($errors->has('category_name'))
                                            <strong style="color: red"> {{$errors->first('category_name')}}</strong>
                                        @endif --}}
                                    </div>
                                    <div class="form-group">
                                        <label for="inputPhoto" class="col-form-label">Hình ảnh bài viết<span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea  class="form-control input-flat" style="height: 200px" placeholder="Tóm tắt bài viết" name="post_desc" ></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea  class="form-control input-flat" style="height: 200px" placeholder="Nội dung bài viết " name="post_content" id="ckeditor6"></textarea>
                                        {{-- @if ($errors->has('category_desc'))
                                            <strong style="color: red"> {{$errors->first('category_desc')}}</strong>
                                        @endif --}}
                                    </div>
